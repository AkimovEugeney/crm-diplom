...
export function deleteClientModal () {
	...
	deleteModalContent.classList.add('delete-modal__content', 'site-modal__content', 'modal_active');
	...
	deleteModalContent.append(title, close, deleteModalText, deleteModalDelete, cancelBtn);
