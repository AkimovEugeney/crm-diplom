...
export function createModalForms () {
	...
	errorBlock.append(writeName, writeSurname, writeLastname, requredValue, requredContacts, unacceptabletLetter);
	form.append(formFloatingName, formFloatingSurname, formFloatingLastname, contactsBlock, errorBlock, saveBtn, cancelBtn);
	...
	return {
		...
		title,
		cancelBtn,
		inputName,inputSurname,inputLastname,
		labelName, labelSurname,labelLastname,
		contactsBlock,
		addContactBtn,
	}
}