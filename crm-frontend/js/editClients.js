...
export function editClientModal (data) {
	...
	editModalContent.classList.add('edit-modal__content', 'site-modal__content', 'modal_active');
	...
	createForm.form.addEventListener('submit', async (e) => {
		...
		try {
			...
			setTimeout(() => {
				...
				document.querySelector('.table__body').append(createClientItem(editedData));
